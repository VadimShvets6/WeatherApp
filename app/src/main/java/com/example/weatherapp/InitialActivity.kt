...
import kotlinx.android.synthetic.main.activity_initial_acivity.*
...
class InitialActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_initial_acivity)
        //button = findViewById(R.id.buttonNext)

        inner_toolbarr.setOnMenuItemClickListener{ menuItem ->
